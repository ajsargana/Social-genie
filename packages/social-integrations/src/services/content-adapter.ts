...
export class ContentAdapter {
  ...
  private static adaptForTwitter(post: ContentPost, capabilities: any): PlatformSpecificContent {
  ...
  private static adaptForInstagram(post: ContentPost, capabilities: any): PlatformSpecificContent {
  ...
  private static adaptForFacebook(post: ContentPost, capabilities: any): PlatformSpecificContent {
  ...
  private static adaptForLinkedIn(post: ContentPost, capabilities: any): PlatformSpecificContent {
  ...
  private static adaptForTikTok(post: ContentPost, capabilities: any): PlatformSpecificContent {
  ...
  private static adaptForYouTube(post: ContentPost, capabilities: any): PlatformSpecificContent {
  ...
  private static adaptForPinterest(post: ContentPost, capabilities: any): PlatformSpecificContent {
  ...
  private static adaptGeneric(post: ContentPost, capabilities: any): PlatformSpecificContent {
  ...
  private static generateAltText(text: string): string {
  ...
  static generateCrossPlatformStrategy(
    content: ContentPost,
    platforms: SocialPlatform[]
  ): Array<{
    platform: SocialPlatform;
    delay: number; // Minutes after original post
  ...
  private static calculateOptimalDelay(platform: SocialPlatform): number {
